...
const allCities = ["Москва", "Санкт-петербург", "Новосибирск",
    ...
    "Приморск","Симферополь","Севастополь","Ялта","Алушта","Курильск","Высоцк", "Братск", "Новороссийск",
    ...
    "Новомосковск", "Черкесск", "Армавир", "Северск", "Воткинск", "Шадринск",
    ...
    "Арзамас", "Брест", "Альметьевск", "Ишим",
    "Сочи", "Ноябрьск", "Анапа", "Воскресенск", "Астана", "Норильск","Сортавала", "Петрозаводск"
];
